  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 p-4 bg-background/95 backdrop-blur-sm border-t border-blue-700/20">
      <div className="container mx-auto max-w-full px-2">
        <div className="flex items-center justify-between max-w-full overflow-x-hidden">
          <Button
            variant={"ghost"}
            size={"icon"}
            onClick={onPrevious}
            ...
            className={cn(
              "rounded-full w-10 h-10 shrink-0 transition-all duration-200 bg-blue-700/20 hover:bg-blue-700/40 border border-blue-700/40 text-blue-600",
          ...
          <div className="flex gap-2 mx-2 overflow-x-auto">
