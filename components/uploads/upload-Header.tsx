...
export default function UploadHeader(){
    ...
    return(
        <div className="flex flex-col items-center justify-center gap-6 text-center  ">
          <div className="relative p-[1px] overflow-hidden rounded-full transition-all duration-300 ease-in-out hover:bg-blue-400 hover:text-black hover:shadow-md animate-gradient-x group">
            <Badge
              variant="secondary"
