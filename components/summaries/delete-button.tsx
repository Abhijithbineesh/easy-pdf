    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <DialogFooter>
          <Button
            variant="ghost"
            className="bg-white border border-gray-300 shadow-sm hover:bg-gray-50 hover:border-gray-400 hover:text-gray-700 transition-all duration-200 rounded-xl text-black"
