    ...
    <div className="flex gap-4 mb-8 justify-between">
      <div className="flex flex-col gap-2">
        <MotionH1
          ...
          initial="hidden"
          whileInView="visible"
          className="text-4xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-blue-900 bg-clip-text text-transparent"
        >
          <Skeleton className="h-10 w-48" />
        </MotionH1>

        {/* ✅ Replaced MotionP with a MotionDiv to avoid nesting <div> in <p> */}
        <MotionDiv
          variants={itemVariants}
          initial="hidden"
          animate="visible"
